...
CREATE TABLE `product` (
                           `item_id` int(11) NOT NULL,   /* id aita int a */
                           `item_brand` varchar(200) NOT NULL, /*  mobile brand  */
                           `item_name` varchar(255) NOT NULL, /* mobile name */
                           `item_price` double(10,2) NOT NULL, /* price double  */
                           `item_image` varchar(255) NOT NULL, /* display image  */
                           `item_register` datetime DEFAULT NULL  /* time of product added in the table  */
                         ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Samsung', 'Samsung Galaxy 10', 152.00, './assets/products/1.png', NOW()), /* NOW() for current time zone */
